...
let userID = "23ab977e-073d-44c0-a8a6-4d8958b66b20";
...
const renderPage = async (env, uuid, host) => {
	...
	<body>
		<h1 style="text-align: center; color: #2980b9">BPB Panel <span style="font-size: smaller;">2.1</span> 馃挦</h1>
		<div class="form-container">
			...
			<form method="POST" id="configForm">
                ...
                <h2>CLEAN IP SETTINGS 鈿欙笍</h2>
				<div class="form-control">
					<label>鉁� Clean IPs</label>
				...
				<div id="apply" class="form-control">
					<div style="grid-column: 2; width: 100%;">
						<input type="submit" class="button" value="APPLY SETTINGS 馃挜" form="configForm">
					</div>
				</div>
			</form>
		...
		document.addEventListener('DOMContentLoaded', () => {
			...
			configForm.addEventListener('submit', (event) => {
				...
				if (lengthMin >= lengthMax || intervalMin >= intervalMax) {
					alert('鉀� Minimum should be smaller than Maximum! 馃');
